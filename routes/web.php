...
Route::get('/notifica', 'App\Http\Controllers\NotificacoesController@notifica');
Route::get('/mail', 'App\Http\Controllers\MailController@send');
Route::get('/_mail/view/{view}', function (string $view) {

  $data = [
    'to' => 'djmarcosban@hotmail.com',
    'subject' => 'Um novo login foi realizado na sua conta',
  ];
  return view('mail.' . $view, compact('data', 'view'));
});