...
@section('content')
  ...
  <style>
    ...
    .etapa_pendente .kanban-item {
      background-color: #fffeda;
      border: 1px solid #b39e5f;
    }

    .etapa_pendente .kanban-item hr {
      color: #ccc6a3 !important
    }

    .etapa_aprovada .kanban-item {
      background-color: #daffde;
      border: 1px solid #5fb367;
    }

    .etapa_aprovada .kanban-item hr {
      color: #a3cca7 !important
    }

    .etapa_cancelada .kanban-item {
      background-color: #ffdada;
      border: 1px solid #b35f5f;
    }

    .etapa_cancelada .kanban-item hr {
      color: #cca3a3 !important
    }

    .etapa_historico .kanban-item {
      background-color: #efefef;
      border: 1px solid #ababab;
    }

    .etapa_historico .kanban-item hr {
            ...
            <div class="kanban-items">
              @foreach ($etapa['reservas'] as $reserva)
                <div class="kanban-item" data-id="{{$reserva->id}}">
                  ...
                  <div class="mt-4">
                    <small class="text-dark">Última alteração em
                      {{\Carbon\Carbon::parse($reserva->updated_at)->format('d/m/Y H:i:s')}}</small>
                  </div>
                </div>
              @endforeach
            </div>
