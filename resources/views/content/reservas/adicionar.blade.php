    ...
    <div class="card-body">
      <div class="row">
        <div class="col-xl-12 col-12 mb-xl-0 mb-4">
          <div class="form-group">
            <label for="descricao" class="form-label">Detalhes Adicionais <small class="text-muted">(Opcional)</small></label>
    ...
    newInventarios.forEach((i) => {
      ...
      horarios.forEach((e) => {
        ...
        newE.forEach((j) => {
          ...
          let jOption = `<option data-semana="${j.dia_semana_key}" data-inicio="${j.horario_inicio}" data-fim="${j.horario_fim}" value="${h}">${h}</option>`;
