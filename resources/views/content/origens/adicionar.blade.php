...
<div class="row py-3 mb-5">
  <div class="col-12 p-xl-0 col-xl-8 align-items-center d-flex">
      ...
      <div class="row">
        <div class="col-xl-2 col-6 mb-4">
          <div class="form-group">
            ...
            <input type="text" name="cep" value="{{@old('cep')}}" id="cep" class="form-control">
          </div>
        </div>
        <div class="col-xl-4 col-12 mb-4">
          <div class="form-group">
            <label for="address" class="form-label">Endereço</label>
            <input type="text" name="address" required value="{{@old('address')}}" id="address" class="form-control">
          </div>
        </div>
        ...
        <div class="col-xl-3 col-6 mb-4">
          <div class="form-group">
            ...
            <input type="text" name="city" required value="{{@old('city')}}" id="city" class="form-control">
          </div>
        </div>
