      ...
      <div class="row">
        <div class="col-xl-10 col-6 mb-4 mb-xl-0">
          <div class="form-group">
            ...
            <input type="text" name="titulo" id="titulo" value="{{$etapa->titulo}}" required class="form-control @error('nome') is-invalid @enderror" />
          </div>
        </div>
        <div class="col-xl-2 col-6 mb-4 mb-xl-0">
          <div class="form-group">
            <label for="posicao" class="form-label">Posição<span class="text-danger">*</span></label>
            <input type="text" name="posicao" id="posicao" value="{{$etapa->posicao}}" required class="form-control @error('nome') is-invalid @enderror" />
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="form-group">
            ...
            <div class="d-flex align-items-center">
              <select name="status" id="status" class="form-select">
                <option {{$etapa->status == 'ativo' ? 'selected' : ''}} value="ativo">Ativo</option>
                <option {{$etapa->status == 'inativo' ? 'selected' : ''}} value="inativo">Inativo</option>
              </select>
            </div>
          </div>
        </div>
